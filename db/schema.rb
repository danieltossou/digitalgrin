...
ActiveRecord::Schema.define(version: 2019_07_23_110802) do
  ...
  create_table "fields_users", id: false, force: :cascade do |t|
    t.integer "field_id"
    t.integer "user_id"
    t.index ["field_id"], name: "index_fields_users_on_field_id"
    t.index ["user_id"], name: "index_fields_users_on_user_id"
  end
